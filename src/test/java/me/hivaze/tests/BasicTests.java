...
public class BasicTests {
    ...
    public void backPropagationIrisTest() throws IOException {
        ...
        Pair<List<List<String>>> split = DatasetUtils.splitInRandomCondition(irisDataset, 0.8, 0.2);
        ...
        System.out.println(neuralNetwork.backPropagationTrain(trainingDataset, 0.005, new double[] { 0.01 }, 100_000));
